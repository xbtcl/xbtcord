...
function ChevronSmallDownIcon(props: any) {
    return (
        <svg viewBox="0 0 24 24" width="24" height="24" className={props.className} style={props.style}>
            <path fill="currentColor" d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z" />
        </svg>
    );
}

function ChevronSmallUpIcon(props: any) {
    return (
        <svg viewBox="0 0 24 24" width="24" height="24" className={props.className} style={props.style}>
...
function ZipPreviewFileRow({ entry }: { entry: ZipEntry; key?: string; }) {
