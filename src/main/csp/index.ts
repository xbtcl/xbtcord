...
export const CspPolicies: PolicyMap = {
    ...
    // CDNs used for some things by Xbtcord.
    ...
    // Function Specific
    "api.github.com": ConnectSrc, // used for updating Xbtcord itself
...
const patchCsp = (headers: PolicyMap) => {
    ...
    if (header) {
        ...
        // we could make unsafe-inline safe by using strict-dynamic with a random nonce on our Xbtcord loader script https://content-security-policy.com/strict-dynamic/
        ...
        for (const directive of ["style-src", "connect-src", "img-src", "font-src", "media-src", "worker-src"]) {
            pushDirective(directive, "blob:", "data:", "xbtcord:", "vesktop:");
        }
