...
import { gitRemote } from "@shared/xbtcordUserAgent";
        ...
        <SettingsTab>
            {isDonor(user?.id)
                ...
                : (
                    <SpecialCard
                        ...
                        description="Please consider supporting the development of Xbtcord by donating!"
            ...
            {isPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Xbtcord you now have a cool new badge!"
                    ...
                    {!IS_WEB && (
                        <>
                            ...
                            <QuickAction
                                ...
                                action={() => XbtcordNative.settings.openFolder()}
                            />
                        </>
                    )}
                    <QuickAction
                        ...
                        action={() => XbtcordNative.native.openExternal("https://github.com/" + gitRemote)}
                    />
                </QuickActionCard>
            </section>
...
export default wrapTab(XbtcordSettings, "Xbtcord Settings");
