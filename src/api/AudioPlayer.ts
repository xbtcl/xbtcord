...
// Equicord's findLazy takes a second "is this an indirect match" argument; this fork's
// does not, and the default behaviour is the same one that flag was asking for.
