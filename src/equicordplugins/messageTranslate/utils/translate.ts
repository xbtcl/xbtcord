...
import { getExcludedLanguages, settings } from "@equicordplugins/messageTranslate/settings";
import { CachedTranslation, TranslateResponse } from "@equicordplugins/messageTranslate/types";
